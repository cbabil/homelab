...
class TestCheckContainerHealth:
    ...
    @pytest.mark.asyncio
    async def test_parses_stopped_status(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_parses_empty_ports(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_limits_logs_to_20_lines(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_unhealthy_when_not_running(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_calls_ssh_with_timeout(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_handles_exception(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_uses_health_check_script(self, status_manager, mock_ssh_executor):
...
class TestGetContainerLogs:
    ...
    @pytest.mark.asyncio
    async def test_returns_logs_dict(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_parses_timestamped_logs(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_default_tail_is_100(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_custom_tail_parameter(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_includes_timestamps_flag(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_returns_container_name(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_returns_line_count(self, status_manager, mock_ssh_executor):
    ...
    @pytest.mark.asyncio
    async def test_skips_empty_lines(self, status_manager, mock_ssh_executor):
