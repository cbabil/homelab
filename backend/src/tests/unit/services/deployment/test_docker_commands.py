...
def full_docker_config():
    ...
    config.volumes = [
        ...
        MagicMock(host_path="/opt/portainer", container_path="/data", readonly=False),
    ]
...
class TestBuildRunCommandBasic:
    ...
    def test_restart_policy_override(self, basic_docker_config):
        ...
        cmd = build_run_command(basic_docker_config, "app", {}, restart_policy="always")
    ...
    def test_restart_policy_none_uses_config_default(self, basic_docker_config):
        ...
        cmd = build_run_command(basic_docker_config, "app", {}, restart_policy=None)
...
class TestBuildRunCommandPorts:
    ...
    def test_single_port_mapping(self, basic_docker_config):
        ...
        basic_docker_config.ports = [MagicMock(container=80, host=8080, protocol="tcp")]
...
class TestBuildRunCommandVolumes:
    ...
    def test_single_volume_mapping(self, basic_docker_config):
        ...
        basic_docker_config.volumes = [
            MagicMock(host_path="/data", container_path="/app/data", readonly=False)
        ]
    ...
    def test_readonly_volume(self, basic_docker_config):
        ...
        basic_docker_config.volumes = [
            MagicMock(host_path="/config", container_path="/etc/config", readonly=True)
        ]
    ...
    def test_multiple_volumes_mixed_readonly(self, basic_docker_config):
        ...
        basic_docker_config.volumes = [
            MagicMock(host_path="/data", container_path="/data", readonly=False),
            MagicMock(host_path="/config", container_path="/config", readonly=True),
        ]
    ...
    def test_volume_path_override(self, basic_docker_config):
        ...
        basic_docker_config.volumes = [
            MagicMock(
                host_path="/default/path", container_path="/app/data", readonly=False
            )
        ]
...
class TestParsePullProgressDownloading:
    ...
    def test_downloading_progress_50_percent(self):
        ...
        parse_pull_progress(
            "def456: Downloading [=========>          ] 50MB/100MB", layer_progress
        )
    ...
    def test_downloading_progress_with_decimal(self):
        ...
        parse_pull_progress(
            "abc123: Downloading [====>    ] 10.5MB/100.5MB", layer_progress
        )
    ...
    def test_downloading_progress_kilobytes(self):
        ...
        parse_pull_progress(
            "abc123: Downloading [====>    ] 512KB/1024KB", layer_progress
        )
    ...
    def test_downloading_progress_gigabytes(self):
        ...
        parse_pull_progress("abc123: Downloading [====>    ] 1GB/4GB", layer_progress)
    ...
    def test_downloading_updates_existing_layer(self):
        ...
        parse_pull_progress(
            "abc123: Downloading [====>    ] 50MB/100MB", layer_progress
        )
...
class TestParsePullProgressExtracting:
    ...
    def test_extracting_progress_start(self):
        ...
        parse_pull_progress(
            "abc123: Extracting [>                   ] 0MB/100MB", layer_progress
        )
    ...
    def test_extracting_progress_middle(self):
        ...
        parse_pull_progress(
            "abc123: Extracting [=========>          ] 50MB/100MB", layer_progress
        )
    ...
    def test_extracting_progress_end(self):
        ...
        parse_pull_progress(
            "abc123: Extracting [===================>] 100MB/100MB", layer_progress
        )
    ...
    def test_extracting_with_decimal(self):
        ...
        parse_pull_progress(
            "abc123: Extracting [=========>          ] 50.5MB/100.0MB", layer_progress
        )
...
class TestParsePullProgressOverall:
    ...
    def test_multiple_layers_progress(self):
        ...
        progress = parse_pull_progress(
            "fed789: Downloading [====>    ] 25MB/100MB", layer_progress
        )
    ...
    def test_progress_capped_at_100(self):
        ...
        parse_pull_progress(
            "abc123: Downloading [===================>] 150MB/100MB", layer_progress
        )
...
class TestParsePullProgressEdgeCases:
    ...
    def test_zero_total_bytes(self):
        ...
        progress = parse_pull_progress(
            "abc123: Downloading [>        ] 0MB/0MB", layer_progress
        )
    ...
    def test_exception_in_progress_calculation(self):
        ...
        progress = parse_pull_progress(
            "abc123: Downloading [====>    ] 50MB/100MB", broken_progress
        )
...
class TestParseContainerInspectBasic:
    ...
    def test_empty_output(self):
        ...
        assert result == {"networks": [], "named_volumes": [], "bind_mounts": []}
...
class TestParseContainerInspectNetworks:
    ...
    def test_single_network(self):
        ...
        data = [
            {
                "NetworkSettings": {"Networks": {"bridge": {"NetworkID": "abc123"}}},
                "Mounts": [],
            }
        ]
    ...
    def test_no_networks(self):
        ...
        data = [{"NetworkSettings": {"Networks": {}}, "Mounts": []}]
...
class TestParseContainerInspectEdgeCases:
    ...
    def test_unknown_mount_type(self):
        ...
        data = [
            {
                "NetworkSettings": {"Networks": {}},
                "Mounts": [{"Type": "tmpfs", "Destination": "/tmp", "Mode": "rw"}],
            }
        ]
    ...
    def test_missing_mount_fields(self):
        ...
        data = [{"NetworkSettings": {"Networks": {}}, "Mounts": [{"Type": "volume"}]}]
    ...
    def test_missing_bind_mount_fields(self):
        ...
        data = [{"NetworkSettings": {"Networks": {}}, "Mounts": [{"Type": "bind"}]}]
        ...
        data = [
            {
                ...
                "NetworkSettings": {
                    "Networks": {
                        "bridge": {"NetworkID": "net123", "IPAddress": "172.17.0.2"}
                    }
                },
                "Mounts": [
                    {
