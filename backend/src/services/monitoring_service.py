...
class MonitoringService:
    ...
    async def get_filtered_logs(self, filters: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if filters:
                log_filter = LogFilter(
                    ...
                    limit=min(int(filters.get("limit", 100)), 1000) if filters.get("limit") else 100
                )
