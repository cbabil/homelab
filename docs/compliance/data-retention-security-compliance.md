...
python3 /opt/homelab/tests/security/test_access_controls.py

# Test 2: Audit log integrity
echo "Testing audit log integrity..."
python3 /opt/homelab/tests/security/test_audit_integrity.py

# Test 3: Input validation
echo "Testing input validation..."
python3 /opt/homelab/tests/security/test_input_validation.py

# Test 4: Session management
echo "Testing session management..."
python3 /opt/homelab/tests/security/test_session_management.py

# Generate test report
python3 /opt/homelab/tests/security/generate_report.py
```
